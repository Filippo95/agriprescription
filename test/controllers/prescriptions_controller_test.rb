...
class PrescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create prescription" do
    assert_difference('Prescription.count') do
      post :create, prescription: { date: @prescription.date, id_company: @prescription.id_company, land: @prescription.land, note: @prescription.note }
    end
  ...
  test "should update prescription" do
    patch :update, id: @prescription, prescription: { date: @prescription.date, id_company: @prescription.id_company, land: @prescription.land, note: @prescription.note }
    assert_redirected_to prescription_path(assigns(:prescription))
  end
